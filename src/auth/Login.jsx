...
const Login = () => {
  ...
  return (
    <div className="w-screen h-screen bg-[#EBF4F6] flex items-center justify-center px-4">
      ...
      <div className="w-full max-w-4xl flex bg-white rounded-3xl shadow-xl shadow-[#088395]/10 overflow-hidden min-h-[520px]">
        ...
        <div className="flex flex-col justify-center w-full md:w-1/2 px-8 sm:px-12 py-10">
          ...
          <h1 className="text-2xl font-bold text-[#071952] mb-1">Welcome back</h1>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                <label className="block text-xs font-semibold text-[#071952] uppercase tracking-wider">
                  Password
                </label>
                <span className="text-xs text-[#088395] hover:text-[#071952] cursor-pointer transition-colors duration-150 font-medium">
                  Forgot password?
                </span>
              </div>
              <div className="relative">
